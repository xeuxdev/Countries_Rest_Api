...
const CountryCard = ({ data }: Data) => {
  return (
    <Link href={`/${data.alpha3Code}`}>
      <div className="card bg-light_Mode_Elements dark:bg-dark_Mode_Elements h-[25.9375rem] w-[20.5rem] lg:h-[21.25rem] lg:w-[16.5625rem] rounded-lg mx-auto lg:mx-0 overflow-hidden shadow-xl shadow-light_Mode_Text/5 cursor-pointer hover:scale-105 duration-300">
        {/* image */}
